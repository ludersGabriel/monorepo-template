...
import { useCoraxForm } from "../form/corax-form-hook"
        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          >
            <div className="flex flex-col gap-6">
              ...
              <form.AppField
                name="password"
                children={field => <field.PasswordField label="Senha" showForgot />}
              />
          ...
          <div className="bg-muted relative hidden md:flex md:items-center md:justify-center md:p-4">
            <HajimeLogo className="fill-primary" />
          </div>
        </CardContent>
      </Card>
